            ...
            <form action="" method="post">
                <ul class="admin_items">
                    ...
                    <li>
                        ...
                        <input type="password" name="user_password"  placeholder="密码" id="pwd" size="35" class="admin_input_style" />
                    </li>

                    <li>
                        <label for="pwd">验证码：</label>
                        <input type="text" name="code" placeholder="验证码" id="pwd" size="35" class="admin_input_style" />
                        <img src="/blog/index.php/Admin/Login/verify" onclick="this.src='/blog/index.php/Admin/Login/verify/'+Math.random();" style="cursor: pointer;width: 150px;" />
                    </li>
