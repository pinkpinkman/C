    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                ...
                <span class="crumb-name">首页管理</span>
            </div>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($firsts)): $i = 0; $__LIST__ = $firsts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if($vo['f_pic'] != null): ?><img src="/blog<?php echo ($vo["f_pic"]); ?>" height="30">
                            <?php else: ?>
                            暂无图片<?php endif; ?>
                            </td>
                            <td>
                                <a class="link-update"  href="/blog/index.php/Admin/First/edit/id/<?php echo ($vo["f_id"]); ?>">修改</a>
                                <a class="link-del"     href="/blog/index.php/Admin/First/del/id/<?php echo ($vo["f_id"]); ?>" onclick="return confirm('你要删除首页文章 <?php echo ($vo["f_title"]); ?>吗?');">删除</a>
                            </td>
