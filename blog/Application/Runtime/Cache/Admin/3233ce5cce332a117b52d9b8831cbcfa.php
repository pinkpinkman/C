                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if($vo['a_pic'] != null): ?><img src="/blog<?php echo ($vo["a_pic"]); ?>" height="30">
                            <?php else: ?>
                            暂无图片<?php endif; ?>
                            </td>
                            <td>
                                <?php if($vo['a_rem'] == 1): ?><span style="color:red">已推荐</span>
                                <?php else: ?>
                                未推荐<?php endif; ?></td>
                            <td>
                                <a class="link-update"  href="/blog/index.php/Admin/Article/edit/id/<?php echo ($vo["a_id"]); ?>">修改</a>
                                <a class="link-del"     href="/blog/index.php/Admin/Article/del/id/<?php echo ($vo["a_id"]); ?>" onclick="return confirm('你要删除文章文章 <?php echo ($vo["a_title"]); ?>吗?');">删除</a>
                            </td>
