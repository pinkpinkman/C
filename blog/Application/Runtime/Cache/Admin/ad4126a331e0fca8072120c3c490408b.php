    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                <a href="/jscss/admin">关于</a>
                <span class="crumb-step">&gt;</span>
                <span class="crumb-name">关于管理</span>
            </div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blog/index.php/Admin/About/add"><i class="icon-font"></i>新增关于</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($abouts)): $i = 0; $__LIST__ = $abouts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if($vo['ab_pic'] != null): ?><img src="/blog<?php echo ($vo["ab_pic"]); ?>" height="30">
                            <?php else: ?>
                            暂无图片<?php endif; ?>
                            </td>
                            <td>
                                <a class="link-update"  href="/blog/index.php/Admin/About/edit/id/<?php echo ($vo["ab_id"]); ?>">修改</a>
                                <a class="link-del"     href="/blog/index.php/Admin/About/del/id/<?php echo ($vo["ab_id"]); ?>" onclick="return confirm('你要删除关于页面 <?php echo ($vo["ab_title"]); ?>吗?');">删除</a>
                            </td>
